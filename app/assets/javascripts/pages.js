$(document).ready(function(){
  ...
  var searchFlickr = function(){
    ...
    $.getJSON('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=5f5a78b55d0916888526ec3b3eb2e3aa&text=' + query + '&per_page=24&page=' + page + '&format=json&jsoncallback=?', processImages);
  };
